...
namespace ItinerariesApi.Models.Gateway
{
    public class SendGridMailer : IMailSender
    {
        ...
        {
            _apiKey = config["ItinerariesApi:SendGridApiKey"];
            string fromEmail = config["ItinerariesApi:SendGridSenderEmail"];
            string fromName = config["ItinerariesApi:SendGridSenderName"];
